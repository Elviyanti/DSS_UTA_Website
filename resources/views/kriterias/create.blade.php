{{-- resources/views/kriterias/create.blade.php --}}
@extends('layouts.app')
...
@push('styles')
    ...
    --}}
    <style>
        .content-kriteria-form-wrapper { /* Opsional wrapper class */
            ...
            theme: {
                ...
                extend: {
                    ...
                    colors: {
                        ...
                        'custom-purple': '#435ebe', // Warna dari contoh alternatif
                        'custom-purple-darker': '#3a50a0', // Warna dari contoh alternatif
                        'custom-red': '#dc3545', // Warna dari contoh alternatif
                        // Anda bisa menambahkan warna lain jika dibutuhkan
                    }
                }
            }
        };
...
@section('content')
    ...
    {{-- </div> --}} {{-- Penutup untuk .content-kriteria-form-wrapper jika digunakan --}}
@endsection
